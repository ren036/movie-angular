...
export class AddNowComponentComponent implements OnInit{
  //表单
  NowDataForm:NowDTO={id:'',name:'',icon:'',
    description: "",
    releasetime: '',
    ordernum: 0,
    like: 0,
  ...
  submitForm(type: string){
      ...
      this.NowDataForm.releasetime=this.convertDateToNumber();
      // this.NowDataForm.no=this.no;
      // console.log('shijian',this.convertDateToNumber());
